...
import useProfile from "@/features/diplomas/hooks/useProfile";
import useUpdateProfile from "@/features/diplomas/hooks/useUpdateProfile";
import useDeleteAccount from "@/features/diplomas/hooks/useDeleteAccount";

import ChangeEmailDialog from "@/features/diplomas/component/ChangeEmailDialog";
import VerifyEmailDialog from "@/features/diplomas/component/VerifyEmailDialog";
import DeleteAccountDialog from "@/features/diplomas/component/DeleteAccountDialog";

import { useNavigate } from "react-router-dom";
import {
    profileSchema,
    type ProfileFormValues,
} from "@/features/diplomas/forms/schema/profileSchema";
...
export default function AdminAccountSettingsPage() {
    ...
    const user =
        rawData?.payload?.user ||
        (rawData?.payload?.id ? rawData?.payload : null) ||
        rawData?.user ||
    ...
    return (
        <div className="min-h-full w-full bg-gray-100">
            ...
            <div className="border-b bg-white px-6 py-3 text-sm">
                ...
                <span className="font-medium text-blue-600">Account Settings</span>
            </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-[180px_1fr]">
                        ...
                        <div className="flex min-h-[500px] flex-col bg-white">
                            ...
                            <button className="flex items-center gap-2 px-4 py-3 text-sm text-gray-500 hover:bg-gray-50">
                                <span onClick={() => navigate("/admin/change-password")}>
                                    Change Password
                                </span>
                            </button>
                        ...
                        <div className="bg-white px-4 py-4">
                                ...
                                <Field className="mt-2">
                                    ...
                                    <div className="flex w-full items-center rounded-md border border-input bg-white">
                                        <button type="button" className="flex items-center gap-2 px-3">
                                            <img src={EgyptFlag} alt="Egypt" className="w-6 object-cover" />
                            ...
                            <ChangeEmailDialog
                                ...
                                onOpenChange={(open) => {
                                    if (!open) setChangeEmailStep("closed");
                                }}
                                onNext={() => setChangeEmailStep("otp")}
                            />
                            ...
                            <VerifyEmailDialog
                                ...
                                onSuccess={() => setChangeEmailStep("closed")}
                            />
